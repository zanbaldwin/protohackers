use crate::utils;
use crate::{Application, ClientInput, Message, ServerOutput};
...
pub(crate) fn handle_stream(id: Uuid, mut stream: TcpStream, transmitter: Sender<Message>) {
...
pub(crate) fn handle_heartbeat_interval(mut stream: TcpStream, interval: std::time::Duration) {
    'heartbeat: loop {
